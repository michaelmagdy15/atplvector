...
export enum View {
  ...
  AGK_SYSTEMS_OXYGEN = 'AGK_SYSTEMS_OXYGEN',
  AGK_ASI = 'AGK_ASI',
  AGK_GYROS = 'AGK_GYROS',
  ...
  GEN_NAV_DATELINE = 'GEN_NAV_DATELINE', // International Date Line
  ...
  POF_STABILITY_SIM = 'POF_STABILITY_SIM',
  POF_COUPLING = 'POF_COUPLING',
  // Principles of Flight - Helicopters (082)
  POF_HELI_HOME = 'POF_HELI_HOME',
  POF_HELI_SUBSONIC = 'POF_HELI_SUBSONIC',
  POF_HELI_TRANSONIC = 'POF_HELI_TRANSONIC',
  POF_HELI_ROTORCRAFT_TYPES = 'POF_HELI_ROTORCRAFT_TYPES',
  POF_HELI_MAIN_ROTOR_AERO = 'POF_HELI_MAIN_ROTOR_AERO',
  POF_HELI_MAIN_ROTOR_MECH = 'POF_HELI_MAIN_ROTOR_MECH',
  POF_HELI_TAIL_ROTORS = 'POF_HELI_TAIL_ROTORS',
  POF_HELI_EQUILIBRIUM = 'POF_HELI_EQUILIBRIUM',
  POF_HELI_FLIGHT_MECH = 'POF_HELI_FLIGHT_MECH',
  ...
  EGYPTAIR_DASHBOARD = 'EGYPTAIR_DASHBOARD',
  EGYPTAIR_REGS_QUIZ = 'EGYPTAIR_REGS_QUIZ',
  EGYPTAIR_FUEL_PLAN = 'EGYPTAIR_FUEL_PLAN',
  EGYPTAIR_NAV_SIM = 'EGYPTAIR_NAV_SIM',
  EGYPTAIR_PERF_CALC = 'EGYPTAIR_PERF_CALC',
  EGYPTAIR_CRM_SIM = 'EGYPTAIR_CRM_SIM',
}
