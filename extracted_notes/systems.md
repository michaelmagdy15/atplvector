...
| · Major structural stressesTension. A force that tends to lengthen a body.Compression. A force that tends to shorten a body.Bending. A perpendicular force that tends to bend an object.Buckling. A compression force that tends to bend a material.Shear. A force that tries to cut a body into two parts.Torsion. A force that tends to twist a body. |  |
| --- | --- |
...
| STRUCTURE MATERIALS· Aircraft structural materialsAluminum alloy.Most used aluminum alloy is called Duralumin, mixing aluminum and copper.This mixture improves mechanical strength.Used in longerons, frames, spars, skin and stringers.Magnesium alloy.Lightweight.Used in gearbox casings, crankcases, wheel rims and pump cases.Steel.High strength and high weight penalty.Used in crankshafts, gear fixing, etc.Titanium.Resistant to high temperatures.Used in turbine casing or jet pipes.Plastic.Used in aircraft interior.Easy to work with, and cheap.Fibre Reinforced PlasticsCarbon Fibre. Used increasingly in aircraft structures. Great strength and low weight.Kevlar Fibre. Strong, light and expensive.Glass Fibre. Common and cheap. |  |
| --- | --- |
...
| · Structure construction typesSandwich construction:Good against bending.Protects inner layers.Damage easily identified by eye.Not suitable for concentrated loads.Honeycomb constructionStronger than sandwich, using a hexagonal structure in the inner layer.Good resistance to damage. | Sandwich construction with honeycomb core |
| --- | --- |
...
| Minor | Reasonably probable10-3 per flight hour | Slight reduction in operational capabilities | Physical discomfort | Slight increase in workload |
| Major | Remote30-5 per flight hour | Significant reduction in operational capabilities or safety margin | Physical distress, possibly including injuries | Physical discomfort or a significant increase in workload |
| Hazardous | Extremely remote10-7 per flight hour | Large reduction in operational capabilities or safety margin | Serious or fatal injury to a small number of occupants | Physical distress or excessive workload impairing ability to perform tasks |
| Catastrophic | Extremely improbable10-9 per flight hour | Safe flight and landing prevented, usually with loss of aircraft | Multiple fatalities | Fatalities or incapacitation |
...
- Two main categories
  - Constant delivery (fixed volume)Manual pumps, gear or piston pumps belong to this categoryThey require an ACOV (Automated Cut-Off Valve) to prevent over-pressure: If pressure exceeds circuit-designed pressure, a portion of the displaced volume is removed from hydraulic circuit and sent back to reservoir, reducing pressure.Cut-in position: Pump output remains on hydraulic lineCut-out position. Pump output goes back to reservoir. This allows constant flow for lubrication even when there are no hydraulic demands.
  - Manual pumps, gear or piston pumps belong to this category
  - They require an ACOV (Automated Cut-Off Valve) to prevent over-pressure: If pressure exceeds circuit-designed pressure, a portion of the displaced volume is removed from hydraulic circuit and sent back to reservoir, reducing pressure.Cut-in position: Pump output remains on hydraulic lineCut-out position. Pump output goes back to reservoir. This allows constant flow for lubrication even when there are no hydraulic demands.
  ...
  - Constant pressure (variable volume)Generally used in modern aircraft. Automatically controlledA swashplate is used to control the amount of fluid entering the system, according to pressure demandsThe angle of the swashplate is controlled by a pressure-sensitive piston
...
- Two types according to the movement created:
  - Linear actuators (pistons)Can be single-acting (hydraulic actuation in one direction only) or double-acting (both directions)Double acting actuators are known as balanced if they have the same area on both sides of piston. This can be achieved by using a dummy ram
...
| · Methods for absorbing landing loadsSpring struts. Bars that absorb weight load, located between wheel and fuselage of light aircraft (e.g C172)Bungee cords. Uses cords or blocks between fuselage and gear.Torsion bar. Bar twists to absorb impact.Basic oleo principle. It stores gas (acting as a spring, supporting the weight of the aircraft) and oil (as a damper, absorbing impact)Separated oleo. Same as basic but oleo and gas are separated by a piston. | Image source: researchgate.net |
| --- | --- |
...
| · Landing-gear position indication and alertingRed. Unlocked or transitioningGreen. Gear down and locked (says nothing about the doors)3 green and 1 red. Gear is down, but gear lever is up. | Image source: rightattitudes.com |
| --- | --- |
...
| · Classification according to amount of discsSingle-disc brakesUsed on small aircraft. Same principle as a bicycle.They auto-centre themselves.Multi-disc brakes are used on medium and large aircraft.A pressure plate compresses the discs, creating friction.Adjuster Assembly and wear indicator move the plates back. | Image source: rotablerepairs.com |
| --- | --- |
...
| · Wheel layoutsCantilever (only fixed at one side)Half fork (only fixed at one side)ForkDual or twin (usual type)Tandem wheels (1 at the front, 1 at the back)Twin Axle Bogie (2 at the front, 2 at the back) | Wheel arrangements, from ICAO Doc 9157, Part 3, Appendix 1 |
| --- | --- |
...
| · Tyre regions:BeadSidewallShoulderCrown | Image source: americantiredistributors.medium.com |
| --- | --- |
...
| · Tyre terminologyTyre creepIt's the circumferential movement of the tyre around the wheelMarkings are painted in order to measure this.Tyre ventingVents are provided to release air (also known as awl holes) | Image source: aerotoolbox.com |
| --- | --- |
...
| · Tyre treadingTread patternsRibbed tread - Lines going up and downBlock pattern - Similar to motor vehicle tyre designChined tyres - They have a rubber flange to deflect water awayAnti-shimmy - They have a twin contact treadRetreading is the addition of new layers of rubber to the crown of the tyre. This increases tyre lifespan. | Image source: aviationhunt.com |
| --- | --- |

| · Tyre wearCaused by high taxi speeds, heavy landings, excessive braking, aquaplanning, etc.Too much wear on the centre of the tyre indicates too much tyre pressureToo much wear on the shoulders of the tyre indicates too low tyre pressure |  |
| --- | --- |
...
- Ailerons and roll spoilers.
  - Asymmetric deflection creates adverse yaw, which can be compensated byDifferential aileronsFrise aileronsSpoilers on the downgoing wingRudder coupling
...
| · Fixed cockpit oxygen systemSystem designOxygen is stored in a bottle under pressure (typically around 1800 psi)A pressure regulator decreases the pressure to a low pressure compatible with human needsOxygen is delivered to each mask through a distribution manifoldEach mask, generally of a "diluter-demand" type, can provide different modes of operation.Modes of operationRegading mixture providedNormal (a combination of cockpit air + oxygen)100% OxygenRegarding flow providedA normal mode at which oxygen only flows while inhalingAn emergency mode which provides a constant flow of oxygen to removes vapors and smoke from the maskSystem protectionSystem is protected from over-pressure through a pressure relief valveIf oxygen bottle is discharged, a blow-out disc visible from the outside changes color to indicate that the system is no longer available | Cockpit oxygen mask flow selector |
| --- | --- |

### FIXED CABIN OXYGEN

| · Cabin fixed oxygen system is a continuous flow system.System requirementsOxygen should last for more than 15 minutesMasks should automatically be deployed at 14.000 ft cabin altitudeThe masks can be released through a pneumatic or electrical system, although they also have a mechanical backup release tool.Mask designPassenger masks have valves that allow oxygen to be mixed with cabin air.Cabin air must NOT be breathed if there's smoke in the cabin.Oxygen generation can be achieved through:Gaseous generatorsGreater autonomyReversible functioningPossibility of flow regulationChemical generatorsReduced weight and volume and easy storageLess risk of explosionLess maintenance requiredOnce chemical reaction is started, it can not be stopped | Image source: fantasticfacts.net |
| --- | --- |

### PORTABLE OXYGEN

| · Portable oxygen bottlesUsed by the crew to move around the cabin.They may have rate selectors.Extra bottles may be used as first-aid or therapeutic oxygen for passengers with special needs. |  |
| --- | --- |



| · Protective Breathing Equipment (Smoke hoods)Used by the crew if harsh environmental conditions exist.Fitted with a filter system that prevents wearers from breathing in unwanted smoke gases and particulates generated in a fire.They may also incorporate a small oxygen generator providing oxygen for a minimum of 15 minutes. |  |
| --- | --- |
...
| · Melting link detectorsTwo contacts held apart by a fusible plugAt a given temperature, the fusible plug melts, closing the circuit and triggering an alarmOnce the circuit is closed, it will remain closed even if the fire has been extinguished, and the alarm will remain triggered |  |
| --- | --- |

| · Differential expansion detectorsDissimilar materials expand at different rates with temperatureWhen subject to heat, a tube is expanded and, contactors are placed inside in a way that will make contact, closing a circuitOnce the heat is gone, the tube will shorten, opening the contact and cancelling the warningCommonly used in wheel well fire detectorsVibrations may trigger a false alarmThe test button only checks for the continuity of the cables. |  |
| --- | --- |
...
| · When pushing an engine fire button:Engine is isolated (pneumatically, hydraulically, electrically and on fuel)Aural fire warning is silenced· Generally, at least two shots of extinguishing agent are available for each single engine (1 for the APU)On the ground, some airplanes automatically deploy the fire extinguishing agent 30 seconds after the fire started |  |
| --- | --- |
