...
| · The troposphereIt's the lowest layer of the atmosphereMost weather occurs here3/4 of the total mass of the atmosphere is contained in this layerAverage lapse rate of 1.98ºC / 1000 ft· The tropopauseIt's a boundary (not actually a layer) between the troposphere and the stratosphereMarks the point where temperature stops decreasing with altitude.Acts as a lid. Almost all weather is "trapped" below it.Altitude varies from 25.000 ft (poles) to 55.000 (Equator). It's also higher in summer compared to winter.Where altitude varies in steps, jet streams occur. |  |
| --- | --- |
...
| · Temperature is measured with a Stevenson ScreenThe screen must have adequate ventilation and be located at a height of 4 feet to avoid ground heating |  |
| --- | --- |
...
| --- | --- | --- | --- | --- |
| Subtropical Jet Stream | FL400 | In the area of subtropical anticyclonesNorthern Hemisphere: 25 - 40º NSouthern Hemisphere: 35 - 45º S | Up to 300 kts | More or less permanent, they only move north or south as subtropical highs move |
| Polar Front Jet Stream | FL300 | Northern Hemisphere: 40º - 60º NSouthern Hemisphere: 40 - 50º S | Up to 150 kts | Associated with Polar Front Depressions |
...
| Dew point | Temperature at which relative humidity becomes at 100%.If air is cooled to dew point, air becomes saturated.If air is cooled beyond dew point, condensation occurs.Dew point can only be equal to or lower than the temperature of the air. |
...
| LOW LEVEL CLOUDSMade of water droplets.Cloud base below 6500 ft |
| --- |
...
| MEDIUM LEVEL CLOUDSMade of water droplets and ice crystalsCloud base between 6500 and 23000 ft |
| --- |
...
| HIGH LEVEL CLOUDSMade of ice crystals. No risk of icing.Cloud base between 16500 and 42500 ft |
| --- |
...
| Cumulus HumilisLow vertical extent. Never associated with precipitation. | Cumulus MediocrisMedium vertical extent. Generally not associated with precipitation. | Towering Cumulus (TCU)Large vertical extent. They can produce precipitaiton in the form of rain showers. Cloud edges well defined, with a cauliflower shape. |
| --- | --- | --- |

| · Cumulonimbus (CB). Largest vertical clouds. They can exist alone or with multiple other CBs in a squall line. They involve:Severe icingSevere turbulenceWindshearLightningDanger in generalCan develop tornadoes, hailstones, and supercellsCumulonimbus species are shown below: |
| --- |
| Cumulonimbus CalvusWell defined edges at the top | Cumulonimbus CapillatusFibruous top | Cumulonimbus IncusA subtype of CB Capillatus. An anvil-like top is formed by windshear at at high altitudes. |

| · Altocumulus Castellanus (AC Castellanus)They look like battlements of a castleThey announce instability |  |
| --- | --- |
...
|  |  |  |
| --- | --- | --- |
| Castellanus | LenticularisAssociated with mountain waves | FractusLike "broken" or ripped off from the original cloud |
|  |
|  |  |  |
| UncinusFibrous, hair-like | VirgaPrecipitation that evaporates before reaching the ground | MammatusProtuberances formed at the underside of CBs |
...
- The resulting type of cloud will depend on atmospheric conditions.
  - Stable air:Stratiform clouds will form on the windward sideAir descends once the trigger is removed, which also causes a stratiform cloud to be formed on the leeward side.Because of the water vapour lost by precipitation around the ridge, cloud base will be higher on the leeward side.
  ...
  - Unstable air:Air continues rising and cloud base forms above crest level.Typical resulting clouds are CU / CB, and, if humid enough, even thunderstorms can result.These conditions can lead to the appearance of a cloud base below crest level and high cloud tops, obscuring high ground.
...
| · Cold frontCold air undercuts warmer air.Typical slopes of 1:50 to 1:80.Associated clouds: CB, TCU, CU.Precipitation 40 nm wide both ahead and behind the front. |  |
| --- | --- |

| · Warm frontWarm air rises over cold air.Typical slopes of 1:150.Associated clouds: CI, CS, AS, NSPrecipitation starts falling 200 nm ahead of front |  |
| --- | --- |
...
| · Back bent occlusionShape of a hookInside the hook, stormy weather that can be even worse than the main occlusionSecondary lows form at the occlusion point, associated with even worse weather |  |
| --- | --- |
...
| · Roaring 40s and Furious 50sWesterly winds in the Southern Hemisphere that have very little land to impede their progress. |  |
| --- | --- |

| · Trade wind directionPredominantly NE and SE windsWhen wind crosses the Equator before reaching the ITCZ, they turn to NW and SW respectively |  |
| --- | --- |
...
| · Katabatic windCold wind blowing down a mountain slope during nightCan happen during the day on ice mountains and on the shadow side |  |
| --- | --- |

| · Anabatic windHappens during the dayHot air goes up the slopesSlower than Katabatic (max 5 kt) |  |
| --- | --- |

| · Foehn windHappens due to orographic liftingWhen air becomes saturated, it cools down at SALRAfter the peak, it goes down again, warming up at DALRWind on the leeward side has a very high temperature and is dry compared to wind on the windward side |  |
| --- | --- |
...
- Runway Visual Range (RVR)
  ...
  - Reported in steps of:25 m until 399 m50 m until 800 m100 m until 2000 m
  - 25 m until 399 m
  - 50 m until 800 m
  - 100 m until 2000 m
...
- Format is RXX/XXXXXX
  - RXX: Runway designatorIf it's the right hand runway, rwy + 50 is used.88 means all runways99 means repetition of last message
  - If it's the right hand runway, rwy + 50 is used.
  - 88 means all runways
  - 99 means repetition of last message
  - First digit: Runway deposits0: Clear1: Damp2: Wet3: Rime or frost4: Dry snow5: Wet snow6: Slush7: Ice8: Compacted snow9: Frozen ridges/: Types of deposit not deported
  - 0: Clear
  - 1: Damp
  - 2: Wet
  - 3: Rime or frost
  ...
  - Second digit: Extent of runway contamination:1: 10% or less2: 11% to 25%5: 26% to 50%9: 51% to 100%/: Not reported
  - 1: 10% or less
  - 2: 11% to 25%
  - 5: 26% to 50%
  - 9: 51% to 100%
  - /: Not reported
  - Third and forth digits: Depth of deposit:00: Less than 1 mm01: 1 mm....90: 90 mm91: Not used92: 10 cm93: 15 cm94: 20 cm
  - 00: Less than 1 mm
  - 01: 1 mm
  - ....
  - 90: 90 mm
  ...
  - 93: 15 cm
  - 94: 20 cm
  - Fifth and sixth digits: Friction coefficient or braking action28. Friction coefficient of 0.2835. Friction coefficient of 0.35or91. Braking action poor92. Braking action medium to poor92. Braking action medium93. Braking action medium to good94. Braking action good95. Braking action good99. Figures unreliable//. Not reported
...
- They provide local reporting, forecast and warning services, such as:
  - METARs and SPECIs
  - TAFs
  - Aerodrome warningsIssued if cyclonic storms, thunderstorm, hail, snow, freezing precipitation, hoar frost, fog, sand or dust storm, strong gusts, squalls, volcanic ash, tsunamis, or any other event such as windshear are forecast.
  ...
  - 
  - Special servicesSome aerodromes have the capability to report special weather phenomenaSome of these services can be strong inversion forecast and alerting (>10ºC), windshear alerting service, RVR values along the runway, custom briefings for requesting flights, SNOTAM, etc.
...
- Special air report (PIREP)
  - Pilots are required to make an special position report whenever they encounter:Severe turbulenceSevere icing conditionsSevere mountain wavesVolcanic ash cloudsVolcanic activitySevere sand or dust stormsAny other meteorological condition that could affect the safety of following aircraft (for example, windshear)
  - Severe turbulence
