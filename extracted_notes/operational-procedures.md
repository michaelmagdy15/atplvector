...
| Isolated aerodrome | An aerodrome is considered isolated if the fuel required (alternate + final reserve) to the nearest adequate alternate is:For turbine-powered aircraft: Fuel for 2 hours at cruise altitudeFor piston-engine aircraft: Fuel for 45 min + 15% trip time or 2 hours at cruise altitude (the lesser) |
...
| · Noise abatement proceduresOperators must establish departure/arrival procedures to minimize the effect of aircraft noise.These procedures shall:Ensure that safety always priority over noise abatementNot significantly increase crew workload during critical phases of flight.In case of emergency, noise abatement procedures don't need be applied.For each type of airplane, two departure procedures must be designed:NADP 1: for close in noise abatementNADP 2: for distant noise abatementEach NADP climb profile can only have one sequence of actions |  |
| --- | --- |
...
| · Nowadays, altimeters are accurate enough to allow for a reduced vertical separation. This is called Reduced Vertical Separation Minima (RVSM):RVSM is implemented in Europe beginning at FL290 until FL410 (both inclusive)1000 ft vertical separation applies between opposite tracks· Operating in RVSM airspace requires:Aircraft certified by authorityOperator certified by authority· To obtain RVSM approval, operators must provide evidence that:RVSM airworthiness approval has been obtainedProcedures for monitoring and reporting height-keeping errors have been establishedA training programme for flight crew has been establishedOperating procedures have been established, specifying:Equipment required for RVSM operationsPre-flight, in-flight and post-flight proceduresIncident reporting |  |
| --- | --- |
...
- Performance Class A (Large) must remain within 60 minutes at OEI speed from an adequate aerodrome
  - This involves Class A aircraft with:MOPSC >= 20MTOM > 45.360 kg
  - MOPSC >= 20
  - MTOM > 45.360 kg
...
- Performance Class A (Small) must remain within 120 minutes at OEI speed (it can be increased to 180 minutes for turbojets) from an adequate aerodrome
  - This involves Class A aircraft with:MOPS <= 19MTOM < 45.360 kg
  - MOPS <= 19
  - MTOM < 45.360 kg
- This involves Class A aircraft with:
  - MOPS <= 19
...
- Each IFR flight must have at least ONE destination alternate unless:
  - A)< 6 hours planned flightAirport with 2 separate runways availableWeather forecast 1 hr either side of ETA as follows:Ceiling above 2000 ft or circling height +500 ft  (whichever is higher)Visibility more than 5 km
  - < 6 hours planned flight
  - Airport with 2 separate runways available
  - Weather forecast 1 hr either side of ETA as follows:Ceiling above 2000 ft or circling height +500 ft  (whichever is higher)Visibility more than 5 km
...
| --- | --- |
| Type B instrument approach | DA/H + 200 ftRVR/VIS + 800 m |
| Type A instrument approach | DA/H or MDA/H + 400 ftRVR/VIS + 1500 m |
| Circling approach operations | MDA/H + 400 ftVIS + 1500 ft |
...
| --- | --- |
| 300 m (day) | Centre line markings; andRunway edge lights |
| 300 m (night) | Centre line markings; andRunway edge lights; andRunway end lights or centre line lights |
| 150 m | Centre line markings; andRunway end lights; andRunway edge lights; andRunway centre line lights |
| 125 m | Centre line markings; andRunway end lights; andRunway edge lights (spaced 60 m or less); andRunway centre line lights (spaced 15 m or less) |
...
- Before commencing CAT II operations, the following guidance applies to PICs / commanders or pilots to whom the conduct of the flight may be delegated, who are new to the aircraft type
  ...
  - 100 m should be added to the applicable CAT II RVR minima when the operation requires a CAT II manual landing to touchdown, untili) a total of 100 hours or 40 sectors has been achieved on the typeii) a total of 50 hours or 20 sectors has been achieved on the type, if the flight crew member has previously been qualified for CAT II manual operations
...
| 1. Explosives2. Gases3. Flammable liquids4. Flammable solids5.Oxides and peroxides6. Toxic / infectious substances7. Radioactive8. Corrosive9. Miscellaneous |  |
| --- | --- |
...
| --- | --- |
| Precision approach | DA/H + 200 ftRVR/VIS + 800 m |
| Non-precision approach, or circling approach | MDA/H + 400 ftRVR/VIS + 1500 m |

### OPERATIONS WITH SPECIFIED MINIMUM NAVIGATION PERFORMANCE (MNPS)

· Restrictions to MNPS airspace

- Aircraft shall only be operated in designated minimum navigation performance specifications (MNPS)airspace in accordance with regional supplementary procedures, where minimum navigationperformance specifications are established, if the operator has been granted an approval by thecompetent authority to conduct such operations
...
- For operation in MNPS airspace along notified special routes the aeroplane should be equippedwith one LRNS
...
- If unable to contact ATC:
  ...
  - If deviation is more than 5 nm, change your altitude:If deviating towards the north, descend 300 ftIf deviating towards the south, climb 300 ft
...
- There is no ATC clearance required for this procedure and it is not necessary that ATC beadvised
