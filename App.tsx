                        ...
                        <div className="relative w-full max-w-sm bg-slate-900 border-l border-white/10 shadow-2xl animate-in slide-in-from-right duration-500 flex flex-col h-full [padding-top:max(env(safe-area-inset-top,0px),var(--sat,0px))] [padding-bottom:max(env(safe-area-inset-bottom,0px),var(--sab,0px))]">
                            <div className="p-4 sm:p-6 border-b border-white/5 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-black text-white tracking-tight text-base sm:text-lg">MISSION CONTROL</span>
                                </div>
                                <button
                                    onClick={() => setMainMenuOpen(false)}
                                    className="p-2.5 text-slate-400 hover:text-white hover:bg-white/10 rounded-xl transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center active:scale-95"
                            ...
                            <div className="p-4 sm:p-6 border-t border-white/5 bg-slate-950/50 pb-6">
