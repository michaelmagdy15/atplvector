...
export const NAV_MAP: SubjectConfig[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Introduction', view: View.PERF_INTRO },
            { label: 'Class A (Jets)', view: View.PERF_CLASS_A },
            { label: 'Class B (Prop)', view: View.PERF_CLASS_B },
            { label: 'Take-off', view: View.PERF_TAKEOFF },
            { label: 'Climb', view: View.PERF_CLIMB },
            { label: 'Cruise', view: View.PERF_CRUISE },
            { label: 'Landing', view: View.PERF_LANDING },
        ]
    },
    {
        id: '033',
        ...
        color: 'sky',
        dashboardView: View.FLIGHT_PLAN_HOME,
        items: [
            { label: 'Dashboard', view: View.FLIGHT_PLAN_HOME, icon: Map },
            { label: 'Introduction', view: View.FLIGHT_PLAN_INTRO },
            { label: 'Fuel Planning', view: View.FLIGHT_PLAN_FUEL },
            { label: 'IFR Planning', view: View.FLIGHT_PLAN_IFR },
        ]
    },
    {
        id: '021',
