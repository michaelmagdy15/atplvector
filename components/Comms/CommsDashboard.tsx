    ...
    return (
        <div className="max-w-7xl mx-auto pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                />
                <Card
                    view={View.RADAR_VECTORS}
                    title="Radar Vectors"
                    desc="Master radar phraseology: Heading, Speed and Altitude vectors."
                    icon={Crosshair} color="red" tag="SIM"
                />
                <Card
                    view={View.TRANSFER_DRILL}
                    title="Transfer Drill"
                    desc="Practice frequency changes and hands-off procedures."
                    icon={Zap} color="red" tag="DRILL"
                />
                <Card
                    view={View.METAR_BUILDER}
                    title="METAR Builder"
                    desc="Learn to construct meteorological reports from raw data."
                    icon={Cloud} color="red" tag="TOOL"
                />
